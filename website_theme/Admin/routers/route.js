...
module.exports = function (app) {
      ...
      app.get('/business-rules', isUserAllowed, businessRulesController.getBusinessRules);
      app.post('/business-rules/add', isUserAllowed, businessRulesController.addBusinessRule);
